...
<section class="notice">
  ...
  <div class="page-title">
            <h2>후기 수정 <small></small></h2>
    <form method="POST" action="${pageContext.request.contextPath}/revieweditok.do">
        <div class="container">
            <table class="vertical">
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" required class="full" value="${AdoptReviewListDTO.title}"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="content" required class="full" style="width: 600px; height: 500px;">${AdoptReviewListDTO.content}</textarea></td>
				</tr>
			</table>
			<input type="hidden" name="seq" value="${AdoptReviewListDTO.seq}">
			<div>
				<button class="btn btn-primary rounded-pill d-inline-flex flex-shrink-0 py-2 px-4"  style="flex-direction: column;">수정하기</button>
			</div>
