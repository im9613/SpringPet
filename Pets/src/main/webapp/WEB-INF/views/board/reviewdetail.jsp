    ...
    <body>
        ...
        <!-- Navbar & Hero End -->
          ...
          <div class="container-fluid feature bg-light py-5">
	        <h2 id=reviewdetail>게시글 상세보기</h2>
            <div class="container py-5">
	        	...
	        	<table class="vertical">
					...
					<tr>
						<th>아이디</th>
						<td>${AdoptReviewListDTO.idMember}</td>
					</tr>
					<tr>
						<th>번호</th>
				...
				<div>
					<button type=button onclick="location.href='/pet/reviewedit.do?seq=${AdoptReviewListDTO.seq}&id=${AdoptReviewListDTO.idMember}';">수정하기</button>
					<button type=button onclick="location.href='/pet/reviewdel.do?seq=${AdoptReviewListDTO.seq}&id=${AdoptReviewListDTO.idMember}';">삭제하기</button>
				</div>
