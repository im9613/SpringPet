...
<section class="notice">
  ...
  <div class="page-title">
            <h2>후기 작성 <small></small></h2>
    <form method="POST" action="${pageContext.request.contextPath}/reviewaddok">
        <div class="container">
            <table class="vertical">
				...
				<tr>
					<th>내용</th>
					<td><textarea name="content" required class="full" style="width: 600px; height: 500px;"></textarea></td>
				</tr>
			</table>
			<div>
				<button class="btn btn-primary rounded-pill d-inline-flex flex-shrink-0 py-2 px-4"  style="flex-direction: column;">등록하기</button>
			</div>
