...
<section class="notice">
  ...
  <div class="page-title">
            <h2>입양 후기 <small>삭제</small></h2>
            
            <h4>정말로 삭제하실건가요?</h4>
    <form method="POST" action="${pageContext.request.contextPath}/reviewdelok.do">
    <input type="hidden" name="seq" value="${AdoptReviewListDTO.seq}">
			<div>
				<button class="btn btn-primary rounded-pill d-inline-flex flex-shrink-0 py-2 px-4"  style="flex-direction: column;">삭제하기</button>
			</div>
   	 </form>
    </div>
