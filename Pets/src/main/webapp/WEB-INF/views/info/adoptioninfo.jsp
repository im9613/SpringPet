...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid feature bg-light py-5">
            ...
            <div class="adoptionabout">
            <ol>
            	<li>입양신청: 입양을 원하시는 분들은 원하는 동물을 선택해 신청서를 작성합니다.</li><br>
            	<li>상담 및 평가: 입양자분과의 상담을 통해 생활환경과 입양 준비 상황을 확인합니다.</li><br>
            	<li>사전 방문: 입양자분의 자택에 사전에 고지 후 방문하여, 반려동물이 생활하는데 적합한지 등 방문 면담이 진행됩니다.</li><br>
            	<li>입양 결정: 상담이 완료된 후 입양이 최종 승인됩니다. Happynimal은 입양자분들이 최상의 선택을 할 수 있도록 지원합니다.</li><br>
            	<li>입양 후 관리: 입양 후에도 필요한 경우 상담을 진행하며, 반려동물의 건강과 행복을 위해 지속적인 관심을 기울입니다.</li>
            </ol>
            </div>
            <br><br>
